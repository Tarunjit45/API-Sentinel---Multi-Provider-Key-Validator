...
[![GitHub License](https://img.shields.io/github/license/Tarunjit45/API-Sentinel---Multi-Provider-Key-Validator?style=flat-square)](LICENSE)
[![CI / Quality Check](https://github.com/Tarunjit45/API-Sentinel---Multi-Provider-Key-Validator/actions/workflows/ci.yml/badge.svg)](https://github.com/Tarunjit45/API-Sentinel---Multi-Provider-Key-Validator/actions)
[![Language](https://img.shields.io/badge/Language-JavaScript/TypeScript-blue?style=flat-square)](https://github.com/Tarunjit45/API-Sentinel---Multi-Provider-Key-Validator)
...
```bash
git clone https://github.com/Tarunjit45/API-Sentinel---Multi-Provider-Key-Validator.git
cd API-Sentinel---Multi-Provider-Key-Validator
```
